...
<html class="photography-demo-2" >
	<head>
		...
		<meta http-equiv="X-UA-Compatible" content="IE=edge">	
                ...
                <title>Tepian Photowork</title>
                <LINK REL="SHORTCUT ICON" HREF="<?php echo base_url('public/images/logo.ico')?>"/>

                <meta property="og:site_name" content="Tepian Photowork">
                <meta property="og:title" content="Tepian Photowork" />
                <meta property="og:description" content="Memories in a snap - photo & video for all needs" />
                <meta property="og:image" itemprop="image" content="<?php echo base_url('public/images/logo.png')?>">
                <meta property="og:type" content="website" />
                <meta property="og:updated_time" content="1440432930" />	

		<meta name="keywords" content="wedding prewedding engagement photography photographer foto nikah murah jasa" />
		<meta name="description" content="Tepian Photowork">
		...
		<link rel="stylesheet" href="<?php echo base_url('public/vendor/font-awesome/css/fontawesome-all.min.css')?>">
