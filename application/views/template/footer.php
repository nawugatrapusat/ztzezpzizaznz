        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p><strong class="text-uppercase">Tepian Photowork</strong> - &copy; Copyright 2018 - All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url('public/vendor/jquery-mousewheel/jquery.mousewheel.min.js') ?>"></script>
